            ...
            for msg in messages:
                ...
                if msg.video or msg.document or msg.photo or msg.audio or msg.animation or msg.sticker:
                    try:
                        ...
                        # Fallback: forward to dump_channel, copy there, download from copy
                        try:
                            forwarded = await msg.forward(client.db_channel.id)
                            ...
                            print(f"Failed fallback download: {fallback_e}")
                            continue
