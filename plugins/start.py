...
from typing import Tuple  # Added for compatibility with older Python versions
...
async def download_and_encrypt_json(client: Client, msg: Message, user_first_name: str, user_id: str, made_at: str) -> Tuple[bytes, str]:
    """
    Download a .json file from a message, add user details, and encrypt it.
    Returns the encrypted data and the original filename.
    """
...
async def upload_encrypted_json(client: Client, encrypted_data: bytes, filename: str, chat_id: int) -> Message:
    """
